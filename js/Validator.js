  ...
  validate(e) {
    ...
    if (elFields[fieldName].email) {
      if (!this.validateEmail(fieldValue)) {
        this.errors[fieldName].push('Invalid email adress');
      }
    }
    ...
    if (
      ...
      this.errors[fieldName].push(
        `Field must have minimum ${elFields[fieldName].minlength} and maximum ${elFields[fieldName].maxlength} characters`
      );
    }
    ...
    if (elFields[fieldName].matching) {
      ...
      if (fieldValue !== matchingEl.value) {
        this.errors[fieldName].push('Password is not matching');
      }
